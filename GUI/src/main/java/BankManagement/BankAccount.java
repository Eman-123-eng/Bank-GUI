...
public class BankAccount {
    ...
    public BankAccount() {
        ...
        try {
            accountCSVReader = new BufferedReader(new FileReader("src/main/java/BankManagement/Accounts.csv"));
        ...
        try {
            ...
            /*for (BankAccount account : BankAccount.accountArrayFile) {
                for (String s : account.operations)
                    System.out.println("The operations of acc no. " + account.acctNo + " are: " + s);
            }*/
    ...
    public static void writeToFile() {
        try {
            ...
            accountCSVWriter.append(',');
            accountCSVWriter.write("Mini-Statement");
            for (BankAccount account : BankAccount.accountArrayFile) {
                accountCSVWriter.append('\n');
                ...
                accountCSVWriter.write(miniState);
            }
